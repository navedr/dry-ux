                        ...
                        <td>
                            <button
                                ...
                                onClick={() =>
                                    modal.show({
                                        content: (
                                            <div>This modal will always be centered irrespective of global config!</div>
                                        ),
                        ...
                        <td>
                            <button
                                ...
                                onClick={() =>
                                    modal.show({
                                        content: (
                                            <div>This modal will never be centered irrespective of global config!</div>
                                        ),
                                            ...
                                            <div>
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        modal
                                                            .getCurrent()
                                                            .overlay.showActions("Pick an action", "Select an action", [
                                                                {
                                                                    content: "Action 1",
                                                                    type: "success",
